...
4. **Interactions Endpoint URL**: point it at your deployed Worker (`https://nali-bot.rxliuli.com`). Press *Save* — this verifies the endpoint (returns `Operational🔥` on GET, handles `PING` correctly).
